...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub_imu = n.subscribe("/imu_topic", 1000, &ImuGrabber::GrabImu, &imugb);
    ros::Subscriber sub_img_rgb = n.subscribe("/rgb_topic", 100, &ImageGrabber::GrabImageRgb, &igb);
    ros::Subscriber sub_img_depth = n.subscribe("/rgb_depth_topic", 100, &ImageGrabber::GrabImageDepth, &igb);
    ...
    SLAM.SaveKeyFrameTrajectoryTUM("ORB-SLAM3-RGBDI.txt");
